namespace edgetorock
{
    ...
    class Program
    {
        ...
        static async Task<MessageResponse> PipeMessage(Message message, object userContext)
        {
            ...
            var cf = RocksHelper._db.GetColumnFamily("edge");
            RocksHelper._db.Put(DateTime.Now.Ticks.ToString(), messageString, cf);
            Console.WriteLine("Message inserted to RocksDB.");

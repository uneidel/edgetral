...
dotnet publish /home/batzi/Dokumente/edgetoredis/edgetorock.csproj
...
sudo docker build -f "/home/batzi/Dokumente/edgerest/Dockerfile" --build-arg EXE_DIR="./bin/Debug/netcoreapp2.0/publish" -t "$CR/$NAME:$TAG" "/home/batzi/Dokumente/edgerest"
